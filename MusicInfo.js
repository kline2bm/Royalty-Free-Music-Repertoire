...
class MusicInfo {
   ...
   * \@AN Alexander Nakarada                   \@AF Arthur Fordsworthy   \@AG Alice Goodworth             \@AY Anonymous
   * \@BB Brian Boyko                          \@BD Brett Van Donsel     \@BK Bryce M. Kline              \@BT Bryan Teoh
   * \@BX Bix L. B. Beiderbecke                \@CL Calixa Lavallée      \@CS Charles-Camille Saint-Saëns \@DS dogsounds
  ...
  static escapeArtists(string) {
    return string
      .replaceAll("@AN", "Alexander Nakarada")   .replaceAll("@AF", "Arthur Fordsworthy")                   .replaceAll("@AG", "Alice Goodworth")
      .replaceAll("@AY", "Anonymous")            .replaceAll("@BB", "Brian Boyko")                          .replaceAll("@BD", "Brett Van Donsel")
      .replaceAll("@BK", "Bryce M. Kline")       .replaceAll("@BT", "Bryan Teoh")                           .replaceAll("@BX", "Bix L. B. Beiderbecke")
      .replaceAll("@CL", "Calixa Lavallée")      .replaceAll("@CS", "Charles-Camille Saint-Saëns")          .replaceAll("@DS", "dogsounds")
